...
class ImageListPages extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      selectedPageSize: 8,
      orderOptions: [
        { column: "title", label: "user name" },
        { column: "domain", label: "Category" },
        { column: "status", label: "Status" }
      ],
      pageSizes: [8, 12, 24],

      categories: [
        { label: "A", value: "speciality1", key: 0 },
        { label: "B", value: "s2", key: 1 },
        { label: "C", value: "S3", key: 2 }
      ],

      selectedOrderOption: { column: "title", label: "user Name" },
